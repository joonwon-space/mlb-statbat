...
3. **REVIEW** — `team-review` (mandatory) → verdict
...
- If fix touches sensitive paths (text_to_sql, database, config): REQUEST CHANGES escalates to user instead of auto-fix
