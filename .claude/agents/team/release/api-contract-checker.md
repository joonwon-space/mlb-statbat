...
- List all routes: `grep -rn "@router\.\|@app\." backend/app --include='*.py'`
- Read Pydantic response schemas: `backend/app/schemas.py`
...
- Read API layer: `frontend/src/lib/` or `frontend/src/services/`
