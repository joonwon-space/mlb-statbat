...
- **ux-gap-analyst**: UX gaps, accessibility, chat experience quality
- **security-posture-analyst**: vulnerabilities, SQL injection risks, API hardening
- **perf-bottleneck-analyst**: performance bottlenecks across all layers
- **product-strategy-analyst**: roadmap alignment, data coverage, feature gaps
...
| **Low Impact** | **NICE TO HAVE** (todo.md P2-P3) | **SKIP** |
...
Format:
```markdown
- [ ] Task description [team-analysis: {ID}]
```
...
- Assign priority tier (P0/P1/P2/P3) based on matrix
